use super::{
    ...
    pool_manager::{next_whirlpool_liquidity, next_whirlpool_reward_infos},
};
use crate::{
    errors::ErrorCode,
...
mod calculate_modify_liquidity_unit_tests {
    ...
    mod xo_position {
        ...
        // Current tick below position
        // Pool virtual liquidity does not change
        ...
        // Current tick inside position
        // Pool virtual liquidity increases
    ...
    mod fees_and_rewards {
        ...
        fn accrued_tokens_ok_closed_position_ticks_remain_initialized() {
            // Pool with 1000 liquidity, fees (a: 100, b: 200) and reward (20)
